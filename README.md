...
Trabalho 1 da disciplina **Tecnicas de Programacao 1 (TP1)** do Departamento de Ciencia da Computacao da Universidade de Brasilia. Implementacao em C++ de dominios (tipos com validacao), entidades (composicao de dominios) e testes unitarios automatizados com padrao setUp/tearDown, documentados com Doxygen. O sistema modela o dominio de **gerenciamento de testes de software**, onde desenvolvedores criam testes e casos de teste com atributos validados por regras de negocio.

---

## Sumario

- [Dominios, Entidades e Testes Unitarios](#dominios-entidades-e-testes-unitarios)
  - [Sumario](#sumario)
...
![Fluxo de execucao de um teste](docs/fluxo_teste.svg)
